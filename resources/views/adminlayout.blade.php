        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="bi bi-coin"></i>Aguz Kasir</h3>
                </a>
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{url('pelanggan')}}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Data Pelanggan</a>
